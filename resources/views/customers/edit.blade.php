...
@section('content')
    ...
    <x-edit-input-field :action="'customers'" :items="$customers">
        <x-input :name="'name'" :label="'Customer Name'" :placeholder="'name'" :value="$customers->name" type="'text'" class="mb-3" />
        <x-input :name="'email'" :label="'Email'" :placeholder="'email'" :value="$customers->email" type="'email'" class="mb-3" />
