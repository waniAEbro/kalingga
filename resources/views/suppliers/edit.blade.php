...
@section('content')
    ...
    <x-edit-input-field :action="'suppliers'" :items="$suppliers">
        <x-input-text :name="'name'" :label="'Supplier Name'" :placeholder="'name'" :value="$suppliers->name" :type="'text'" class="mb-3" />
        <x-input-text :name="'email'" :label="'Email'" :placeholder="'email'" :value="$suppliers->email" :type="'email'" class="mb-3" />
