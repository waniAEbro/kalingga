...
@push('script')
    <script>
        ...
        function buildTable() {
            ...
            myList.forEach(list => {
                let row = `<tr id="daftar-item" class="text-sm bg-white  drop-shadow-[0_0_15px_rgba(0,0,0,0.05)]">
                        <td class="p-4 border-r rounded-l-lg border-slate-200">${++data.trimStart}</td>
                        <td class="p-4 break-words">${list.name}</td>
                        <td class="p-4 break-words">${list.email}</td>
                        <td class="p-4 break-words">${list.phone}</td>
                        <td class="p-4 break-words">${list.address}</td>
