...
@section('content')
    <div x-data="data()" class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <form method="post" action="/components/{{ $component->id }}">
            @csrf
            @method('put')
            <div class="space-y-12">
                <div class="border-b border-gray-900/10 p-12">
                    <h2 class="text-base font-semibold leading-7 text-gray-900">Update Component</h2>
                            ...
                            <div class="mt-2">
                                <div
                                    ...
                                    <input type="text" name="name" id="name"
                                        ...
                                        placeholder="kayu" value="{{ $component->name }}">
                                </div>
                            </div>
                        </div>
                        <div class="sm:col-span-4">
                            ...
                            <div class="mt-2">
                                <div
                                    ...
                                    <input type="text" name="unit" id="unit"
                                        class="block flex-1 border-0 bg-transparent p-2 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                                        placeholder="m" value="{{ $component->unit }}">
                                </div>
                            </div>
                        </div>
                        <div class="sm:col-span-4">
                            ...
                            <div class="mt-2">
                                <div
                                    ...
                                    <input type="number" name="price_per_unit" id="price_per_unit"
                                        class="block flex-1 border-0 bg-transparent p-2 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
                                        placeholder="10000" value="{{ $component->price_per_unit }}">
                                </div>
                            </div>
                        </div>
                    </div>
