...
<a href="/{{ strtolower($menuUrl) }}"
    ...
    <div
        class="opacity-0 max-xl:group-hover:opacity-100 max-xl:group-hover:left-24 transition-all absolute bg-[#064E3B] text-[#F4F7F6] py-1 px-3 rounded text-sm z-10 left-20">
        {{ $menuName }}
    </div>
