...
<a id="warehouse" href="/{{ strtolower($menuUrl) }}"
    ...
    <div
        class="opacity-0 max-xl:group-hover:opacity-100 max-xl:group-hover:left-24 transition-all text-[#F4F7F6] absolute bg-[#064E3B] py-1 px-3 rounded text-sm z-10 left-20">
        {{ $menuName }}
    </div>
</a>
