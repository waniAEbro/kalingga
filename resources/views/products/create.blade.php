        ...
        <form action="{{ route('products.store') }}" method="POST" class="w-full form-control">
            ...
            <div class="flex gap-5">
                ...
                <div>
                    ...
                    <div x-data="{ componentId: null, quantity: 0 }" class="flex gap-5 mt-2 w-fit items-center">
                        ...
                        <input x-model="quantity" placeholder="Qty" name="quantities[]" type="number"
                        ...
                        <template x-if="componentId">
                            <p x-data="{ unit: components.find(c => c.id == componentId).unit, priceUnit: components.find(c => c.id == componentId).price_per_unit }">
                                ...
                                = Rp<span x-text="quantity*priceUnit"></span>
                            </p>
                        </template>
                    ...
                    <div id="add-component-container" x-data>
            ...
            <div class="flex justify-end w-full gap-5">
                <button type="button"
                    class="float-left w-32 mt-5 text-white normal-case rounded btn btn-warning">Cancel</button>
                <button type="submit"
