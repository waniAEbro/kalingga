                    ...
                    @else
                        @foreach ($product->components as $cp)
                            <tr x-data="{ component: $el }" class="border-b">
                                <td id="number-component" class="p-2 text-center"></td>
                                <td class="w-40 p-2">
                                    <x-select :value="$cp->id" :label="$cp->name" x-on:click="getComponent(component); $nextTick();" :dataLists="$components->toArray()"
                    ...
                    @else
                        @foreach ($product->suppliers as $supplier)
                            ...
                            <tr x-data="{ supplier: $el }" class="border-b">
                                <td id="number-supplier" class="p-2 text-center"></td>
                                <td class="p-2">
                                    <x-select :value="$supplier->id" :label="$supplier->name" :dataLists="$suppliers->toArray()" :name="'supplier_id[]'" :id="'supplier_id'" :new="'newSupplierModal(supplier)'" />
                                </td>
                                <td class="p-2">
